...
class BaseStatementHandlerTest {
  ...
  @Test
  void specifyMappedStatementMaxRows() throws SQLException {
    BaseStatementHandler handler = new SimpleStatementHandler(null, mappedStatementBuilder.maxRows(10).build(), null,
        null, null, null);
    handler.setMaxRows(statement);
